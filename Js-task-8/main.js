...
// tasks
// 1) random 1-30 arasi reqem veren function yaradin ;

// console.log(Math.floor(Math.random() *30));

// 2) random functiondan istifade ederek ele bir function qurun ki hemin reqemi
// yaratdiginiz functiona parametr olaraq verin hemin reqeme gore idisini tapsin 
// tapilan id li elementi localstorageye gonderin ve logda gosterin
...
//         }else{
//         throw new Error(`Id ${id} melumati tapilmadi ! `);
//         }
//     } catch (error) {
//         console.error(error)
//     }
...
// 3) ele bir func qurun ki paremtr olaraq key verildiyinde gedib localstorageden
// hemin keye gore elementi silsin

// const Deleteitem = (key) => {
//     try {
//         letfindKey = localStorage.getItem(key)
//         if(findKey){
//             localStorage.removeItem(key)
//         }else{
//             throw new Error(`${key} movcud deyil!`);
...
// 4) users arrayindeki butun nomrelerin yerine random reqemler yaradin
// yeni her bir users arrayin icindeki elementler in icindeki phone ferqli random reqemler
// olsun meselen phone : 055-123-45-98;

// const randomnumber = (length) => Math.floor(Math.random() * length);

// let operator = ["050","051","055","070","077","099"]

// const updateuser = () => {
//     try {
//       users.forEach((item)=>{
//         let number = item.phone;
//         let newOperator = operator[randomnumber(operator.length)];
//         let randomnumbers = `${randomnumber(10)}${randomnumber(10)}${randomnumber(10)} -${randomnumber(10)}${randomnumber(10)} - ${randomnumber(10)}${randomnumber(10)}`
//         item.phone = `${newOperator} -${randomnumbers}`
...
// 5) new Date den istifade ederek usersdeki istifadecilerin dogum ilini cixaraq
// her istifadecinin yasini hesablayib teyin eden function qurun

// const birthday = () => {
//     try {
//       let date = new Date();
//       users.forEach((item) =>{
//         let birthYear = item.birthDate.split("-")[0];
//         let newAge = date.getFullYear() - birthYear;
//         item.newAge = newAge
//         console.log(item);
